...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x2e, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xaa, 0x01,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e,
	...
	,
...
var file_proto_health_proto_goTypes = []interface{}{
	...
	(*HealthCheckRequest)(nil),             // 1: product.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: product.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: product.HealthCheckResponse.status:type_name -> product.HealthCheckResponse.ServingStatus
	1, // 1: product.Health.Check:input_type -> product.HealthCheckRequest
	1, // 2: product.Health.Watch:input_type -> product.HealthCheckRequest
	2, // 3: product.Health.Check:output_type -> product.HealthCheckResponse
	2, // 4: product.Health.Watch:output_type -> product.HealthCheckResponse
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/product.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Health_serviceDesc.Streams[0], "/product.Health/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.Health/Check",
	}
